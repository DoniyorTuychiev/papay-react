                            ...
                            return (
                              <Box className={"dish_box"} key={`${index}`}>
                                <Box
                                  className={"dish_img"}
                                  sx={{
                                    backgroundImage: `url(/others/sabzi_qovurma.jpg)`,
                                  }}
                                >
                                  ...
                                  <Button
                                    ...
                                    style={{ left: "36px" }}
                                  >
                                    <Badge badgeContent={75} color="primary">
                                      <Checkbox
                                ...
                                <Box className={"dish_desc"}>
                                  <span className="dish_title_text">Sabzi qovurma</span>
                                  <div className="dish_desc_text">
                                    <MonetizationOnIcon />8.1
                                  </div>
                                </Box>
                              </Box>
                            );
                      ...
                      return (
                        <Box className={"review_box"} key={index}>
                          <Box display={"flex"} justifyContent={"center"}>
                            <img src="/community/mirzabek.jpg" className="review_img" />
                          </Box>
                          <span className="review_name">Mirzabek Xolmedov</span>
            ...
            <Container className='member_reviews'>
                ...
                >
                  <Box
                    ...
                    sx={{ backgroundImage: `url(/restaurant/basribaba.jpg)` }}
                  >
                    <div className="about_left_desc">
                      <span>Burak</span>
                      <p>Eng mazzali oshxona va Ishonchli</p>
                    </div>
                  </Box>
                ...
                >
                  ...
                  <iframe
                    ...
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2998.4655950279453!2d69.24305457559393!3d41.2769703028375!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38aef57107ea0dc1%3A0x4931486d0e2aae6b!2sBasri%20Baba!5e0!3m2!1sen!2skr!4v1700734216961!5m2!1sen!2skr"
                    width={"1320"}
                    height={"500"}
